...
import { ArrowLeft, Lightbulb, MessageCircle, Mail, Camera, Info } from 'lucide-react'
    ...
    <>
      ...
      <div id="app-content" className="flex flex-col gap-4 p-8">
        ...
        <HelpSection Icon={MessageCircle} title="联系支持">
          <p className="text-slate-300">如果您遇到问题或有建议，请通过以下方式联系我们：</p>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
            <div className="rounded-xl border border-white/10 bg-white/5 p-4">
              ...
              <p className="text-slate-300">
                <span className="font-semibold text-white">794637387@qq.com</span>
